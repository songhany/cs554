...
import PageShows from './components/PageShows';
    ...
    <Router>
      <div className="App">
        <header className="App-header">
          ...
          <Link className="showlink" to="/shows/page/0">Pagination</Link>
        </header>
        <br />
        <br />
        <div className="App-body">
          ...
          <Route exact path="/shows/page/:pagenum" component={PageShows}/>  {/* ❤ "/shows/page/:pagenum" will generate 'props.match.params.pagenum' */}
        </div>
      </div>
    </Router>
  );
