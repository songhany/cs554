...
router.get('/', async (req, res) => {
  ...
  store.subscribe(() => {  // subscribe the store, every time there is state change, it will console.log() it
  ...
  console.log(store.getState().user);   // get a piece of state, which is just 'user'
