$(function () {
  ...
  QUnit.test(
    ...
    function (assert) {
      ...
      $('<ol><li id="home"/><li id="profile"/></ol>').appendTo(
        '#qunit-fixture'
      );
  ...
  QUnit.test(
    'should activate element by tab id in nav list',
    function (assert) {
      assert.expect(2);
      var tabsHTML =
        '<nav class="nav">' +
  ...
  QUnit.test(
    'should activate element by tab id in list group',
    function (assert) {
      assert.expect(2);
      var tabsHTML =
  ...
  QUnit.test(
    'selected tab should deactivate previous selected tab',
    function (assert) {
      assert.expect(2);
      var tabsHTML =
        '<ul class="nav nav-tabs">' +
