...
const resolvers = {  // resolvers are just function that perform your database stuff. For example, our data are coming from database instead of filtering the array. you will make a call to your database
  Query: {
  ...
  // Once we have our query, we need resolvers for our type
  Employer: {
